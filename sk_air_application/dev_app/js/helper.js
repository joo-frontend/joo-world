...
Handlebars.registerHelper("deviceDetailReferSendHm", function (data) {
    ...
    if(App.view.schoolDetail != undefined){
        if(App.view.schoolDetail.deviceDetailRefer.sendHm != undefined){
            if(App.view.schoolDetail.deviceDetailRefer.sendHm == ""){
                return "";
            }else{
                var sendHText;
                var sendHm =  moment(App.view.schoolDetail.deviceDetailRefer.sendHm, "HHmm").format("HH:mm");
                var sendH =  moment(App.view.schoolDetail.deviceDetailRefer.sendHm, "HHmm").format("HH");
        ...
        }else if (App.view.schoolDetail.deviceDetailRefer.sendHm == undefined ){
            return "";
        }
    ...
    if(App.view.schoolDetail != undefined){
        if(App.view.schoolDetail.deviceDetailRefer.sendHm != undefined){
            if(App.view.schoolDetail.deviceDetailRefer.sendHm == ""){
                ...
                var alarmData = App.view.schoolDetail.deviceDetailRefer.sendMd + App.view.schoolDetail.deviceDetailRefer.sendHm;
