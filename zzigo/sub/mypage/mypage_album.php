...
<!--                        <li class="">-->
<!--                            <a href=""><span>새로 만들기</span></a>-->
<!--                        </li>-->
<!--                        <li class="album-sub">-->
<!--                            <a href=""><span class="sub-ul-active">내 앨범목록</span></a>-->
<!--                            <ul class="album-sub-ul ">-->
<!--                                <li>-->
<!--                                    <a href=""><span>웨딩앨범 의뢰</span></a>-->
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <a href=""><span>신혼여행앨범 의뢰</span></a>-->
<!--                                </li>-->
<!--                            </ul>-->
<!--                        </li>-->
<!--                        <li>-->
<!--                            <a href=""><span>완료된 앨범</span></a>-->
<!--                        </li>-->
<!--                        <li>-->
<!--                            <a href=""><span>백업</span></a>-->
<!--                        </li>-->
<!--                    </ul>-->
<!--                </div>-->
                    ...
                    <div class="album-table">
                        ...
                        <div class="album-tbody">
                            <div class="album-list album-list-row">
                                ...
                                <div class="cell col5">
                                    <a href="">
                                        <button type="button" class="design-view-btn">디자인 확인하기</button>
                                    </a>
                                </div>
                            </div>
                            <div class="album-list album-list-row">
                                <div class="cell col2">신혼여행앨범 의뢰</div>
                                <div class="cell col3">2018.06.24</div>
                                <div class="cell col4">8.5GB</div>
                                <div class="cell col5">
                                    컨펌완료
                                </div>
                            </div>
