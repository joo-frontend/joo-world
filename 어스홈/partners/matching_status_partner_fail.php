...
<div class="wra_matching">
	...
	<div class="section_menu_mypage section_matching_status section_partner_matching">
		<div class="area_matching_status area_partner_matching_status">
			...
			<!-- 매칭 실패 -->
			<div class="box_matching_status_txt fail_matching">
				<p class="status_txt">매칭에 실패 하였습니다</p>
			</div>
			...
			<div class="box_status">
				...
				<div class="status_contents">
					...
					<div class="status_date">
						...
						<p class="desc">입찰신청이 성공적으로 등록되었습니다</p>
			...
			<div class="box_status">
				...
				<div class="status_contents">
					...
					<div class="status_date">
						...
						<p class="desc">매칭에 참여한 파트너스는 총 10곳 입니다<br>파트너스에 대한 정보는 프로필을 통해 확인 가능합니다</p>
			...
			<div class="box_status">
				...
				<div class="status_contents">
					...
					<div class="status_date">
						<p class="date">18.05.16</p>
						<p class="desc">파트너가 선정이 완료 되었습니다<br>
아쉽지만 파트너로 선정되지 못하였습니다</p>
						<p class="desc_focus">
							축하합니다! 파트너로 선정되었습니다
						</p>
