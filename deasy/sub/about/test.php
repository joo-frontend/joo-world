<?php require_once ('/DK/inhouse/deasy-frontend/www/public_html/assets/element/header.php');?>
    <div class="brand_core1">
        ...
        <div class="slide_section_pj">
            <div class="slide_brand_pj">
                <img src="/assets/images/about/brand/pc.png" alt="">
            </div>
            <div class="pc_img_bg">
                <!--<div class="swiper-container" id="slidePcDeasy">
    ...
    <div class="brand_goal">
        <div class="elements_goal_area">
            <div class="layout_brand">
                <p class="lb_overview lb_white wow fadeInUp">[ PROJECT GOAL ]</p>
                <p class="focus_on_title f_mont wow fadeInUp">WE FOCUSED ON -</p>
                ...
                <p class="lb_overview lb_white">[ PROJECT  TARGET ]</p>
            </div>
        </div>
    </div>
    <div class="brand_direction">
        <div class="layout_brand">
            <p class="imgbox"><img src="/assets/images/about/goal/graph.svg" alt=""></p>
            <div class="focus_on_content">
                <div class="item_focus">
    ...
    <div class="brand_core2">
        <div class="layout_brand">
            <div class="core_title f_mont core_title_white">
                Brand Core<br>
                Service.2
                <span class="arrow"><img src="/assets/images/about/brand/down.png" alt=""></span>
            </div>
            <p class="core_intro_txt core_intro_txt_white">
    ...
    <script>
        ...
        setInterval(function () {
            ...
            if(i <= (unit*4.5)){
                i = -452;
                no = 1;
                $(".auto_slide_container").css({"margin-left":"-441px"});
