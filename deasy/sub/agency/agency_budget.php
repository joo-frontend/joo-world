...
<div class="budget_wra">
        ...
        <div class="setting_budget_section">
            <div class="setting_budget_price clearfix">
                <dl>
                    <dt>천만</dt>
                    <dd class="thousand">
                        <input type="hidden" name="budgetPrice1000Value" value="0" class="pricebox_hidden">
                        <input type="number" name="budgetPrice1000" value="0" class="pricebox f_mont"
                               disabled>
                ...
                <dl>
                    <dt>백만</dt>
                    <dd class="hundred">
                        <input type="hidden" name="budgetPrice100Value" value="0" class="pricebox_hidden">
                        <input type="number" name="budgetPrice100" value="0" class="pricebox f_mont" disabled>
                        <p class="price_arrow up">
                            <img class="hover_off" src="/assets/images/project/P6/up_off.png" alt="">
                            <img class="hover_on" src="/assets/images/project/P6/up_on.png" alt="">
                        </p>
                ...
                <dl>
                    <dt>십만</dt>
                    <dd class="ten">
                        <input type="hidden" name="budgetPrice10Value" value="0" class="pricebox_hidden">
                        <input type="number" name="budgetPrice10" value="0" class="pricebox f_mont" disabled>
                        <p class="price_arrow up">
                            <img class="hover_off" src="/assets/images/project/P6/up_off.png" alt="">
                            <img class="hover_on" src="/assets/images/project/P6/up_on.png" alt="">
                        </p>
    ...
    <div class="step_project">
        <a href="/sub/agency/agency_schedule.php" class="arrow_step next">
    ...
    <div class="step_project_m">
        ...
        <a href="/sub/agency/agency_schedule.php" class="next">
...
<script>
    ...
    /*function resizable (el, factor) {
        var int = Number(factor) || 0.7;
        function resize() {
            if(el.value.length >=5){
                el.style.width = "calc("+((el.value.length) * int)+'em - 0.9em)'
            }else{
                el.style.width = ((el.value.length) * int) + 'em'
            }
        }
    ...
    resizable(document.getElementById('txtPrice'),0.7);*/
