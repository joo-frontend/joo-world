...
<div class="project_date_wra">
    <div class="project_date_area">
            ...
            <div class="final_date_box">
                <form>
                    <div class="box_date box_start_date">
                        <p class="title">시작일
                        <p>
                            <input type="number" class="finalDatebox year" name="pjBudgetStartYear" value="0000" disabled><span>년</span>
                            <input type="number" class="finalDatebox month1" name="pjBudgetStartMonth1" value="0" disabled>
                            <input type="number" class="finalDatebox month2" name="pjBudgetStartMonth2" value="0" disabled><span>월</span>
                            <input type="number" class="finalDatebox day1" name="pjBudgetStartDay1" value="0" disabled>
                            <input type="number" class="finalDatebox day2" name="pjBudgetStartDay2" value="0" disabled><span>일</span>
                    </div>
                    <div class="box_date box_end_date">
                        <p class="title">마감일
                        <p>
                            <input type="number" class="finalDatebox year" name="pjBudgetEndYear" value="0000" disabled><span>년</span>
                            <input type="number" class="finalDatebox month1" name="pjBudgetEndMonth1" value="0" disabled>
                            <input type="number" class="finalDatebox month2" name="pjBudgetEndMonth2" value="0" disabled><span>월</span>
                            <input type="number" class="finalDatebox day1" name="pjBudgetEndDay1" value="0" disabled>
                            <input type="number" class="finalDatebox day2" name="pjBudgetEndDay2" value="0" disabled><span>일</span>
                    </div>
                    <a href="#" class="dateBtn">날짜 직접입력</a>
                    <div class="entry_date_box">
                        <div class="date_entry_directly start">
                    ...
                    <div class="period">
                        <p><!--<span class="text">총 진행 기간</span> --><span class="f_mont day"><strong>10</strong>일</span></p>
                    </div>
                </form>
            </div>
        </div>
        <div class="step_project">
            <a href="/sub/agency/agency_step1.php" class="arrow_step next">
        ...
        <div class="step_project_m">
            ...
            <a href="/sub/agency/agency_step1.php" class="next">
