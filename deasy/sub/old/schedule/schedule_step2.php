        ...
        <div class="choice_partner_step">
            <div class="my_project_condition">
                ...
                <div class="condition_pj first">
                    <p class="lb">기간</p>
                    <p class="budget"><span class="f_mont">15</span>일 <b class="date">2018.07.24 - 2018.08.03</b></p>
                    <a class="reset_move" href="schedule.php">
                ...
                <div class="condition_pj">
                    <p class="lb">분야</p>
                    <p class="type">로고</p>
                    <a class="reset_move" href="schedule_step1.php">
                        <img class="hover_off" src="/assets/images/project/P9/reset.png" alt=""><img
                                class="hover_on" src="/assets/images/project/P9/reset_on.png" alt="">
                        분야 다시설정</a>
                </div>
            ...
            <div class="reset_btn_group">
                <a class="reset_move" href="schedule.php">
                    <span><img class="hover_on" src="/assets/images/project/P9/reset_on.png" alt="">기간</span>
                    다시설정</a>
                <a class="reset_move" href="schedule_step1.php">
            ...
            <div class="step_project" >
                <a href="schedule_step3_1.php" class="arrow_step next">
                ...
                <a href="schedule_step1.php" class="arrow_step before">
            ...
            <div class="step_project_m">
                <a href="/sub/old/scheduledule/schedule_step1.php" class="prev">
                    <img src="/assets/images/project/P10/porfolio_before.png" alt=""> PREV
                </a>
                <a href="/sub/old/scheduledule/schedule_step3_1.php" class="next">
...
<script>
    var swiper = new Swiper('#slidePf1', {
        pagination: {
    ...
    var swiper2 = new Swiper('#slidePf2', {
        pagination: {
            el: '.swiper-pagination',
            clickable: true,
        },
    ...
    var swiper3 = new Swiper('#slidePf3', {
        pagination: {
            el: '.swiper-pagination',
            clickable: true,
        },
    ...
    var swiper4 = new Swiper('#slidePf4', {
        pagination: {
            el: '.swiper-pagination',
            clickable: true,
        },
    ...
    var swiper5 = new Swiper('#slidePf5', {
        pagination: {
            el: '.swiper-pagination',
            clickable: true,
        },
    ...
    var swiper6 = new Swiper('#slidePf6', {
        pagination: {
            el: '.swiper-pagination',
            clickable: true,
        },
