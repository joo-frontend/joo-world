...
<div class="project_date_wra project_date_blue_wra">
    <div class="project_date_area">
        <div class="page_title_section page_title_white_section">
            <p class="page_title page_title_white f_mont">Schedule</p>
            ...
            <div class="date_entry_directly start">
                ...
                <p class="entry_date">
                    ...
                    <input type="text" class="datebox directStartDay" maxlength="2"
                           placeholder="숫자 입력"><span>일</span>
                </p>
                <div class="box_hidden">
                    <input type="text" name="datetrangeS1" class="datetrange " id="date-rangeStart" value=""/>
                </div>
                <!--<div class="box_direct_date">
                    <input type="text" name="datetrangeS1" class="datetrange " id="date-rangeStart" value=""/>
                </div>-->
            </div>
            <div class="date_entry_directly end">
                <p class="title">마감일</p>
                <p class="entry_date">
                    <input type="text" class="datebox directEndYear" maxlength="4"
                           placeholder="숫자 입력"><span>년</span>
                </p>
                <p class="entry_date">
                    <input type="text" class="datebox directEndMonth" maxlength="2"
                           placeholder="숫자 입력"><span>월</span>
                    <input type="text" class="datebox directEndDay" maxlength="2"
                           placeholder="숫자 입력"><span>일</span>
                </p>
                <div class="box_hidden">
                    <input type="text" name="datetrangeS2" class="datetrange" id="date-rangeEnd" value=""/>
                </div>
                <!--<div class="box_direct_date">
                    <input type="text" name="datetrangeS2" class="datetrange" id="date-rangeEnd" value=""/>
                </div>-->
            ...
            <div class="final_date_box">
                <form>
                    <div class="box_date box_start_date">
                        <p class="title">시작일
                        <p>
                            <input type="number" class="finalDatebox year" name="pjStartYear" value="2018" disabled><span>년</span>
                            <input type="number" class="finalDatebox month1" name="pjStartMonth1" value="0" disabled>
                            <input type="number" class="finalDatebox month2" name="pjStartMonth2" value="8" disabled><span>월</span>
                            <input type="number" class="finalDatebox day1" name="pjStartDay1" value="0" disabled>
                            <input type="number" class="finalDatebox day2" name="pjStartDay2" value="3" disabled><span>일</span>
                        </p>
                    </div>
                    <div class="box_date box_end_date">
                        <p class="title">마감일
                        <p>
                            <input type="number" class="finalDatebox year" name="pjEndYear" value="2018" disabled><span>년</span>
                            <input type="number" class="finalDatebox month1" name="pjEndMonth1" value="0" disabled>
                            <input type="number" class="finalDatebox month2" name="pjEndMonth2" value="8" disabled><span>월</span>
                            <input type="number" class="finalDatebox day1" name="pjEndDay1" value="1" disabled>
                            <input type="number" class="finalDatebox day2" name="pjEndDay2" value="2" disabled><span>일</span>
                        </p>
                    </div>
                    <div class="period">
        ...
        <div class="step_project">
            <a href="schedule_step1.php" class="arrow_step next">
        ...
        <div class="step_project_m">
            <a href="/index.php#typePJ" class="prev">
                <img src="/assets/images/project/P10/porfolio_before.png" alt=""> PREV
            </a>
            <a href="/sub/old/scheduledule/schedule_step1.php" class="next">
...
<script>
    ...
    $('.datetrange').dateRangePicker({
        ...
        showDateFilter: function(time, date) {
            /*$(".date-picker-wrapper .month-wrapper table di v.day").wrap("<div class='wrap-day'></div>");*/
            /*date.wrap("<div class='wrap-day'></div>");*/
        ...
        getValue: function () {
            ...
            $(".directStartDay").on("change touchmove", function () {
                var directStartYear = $(".directStartYear").val();
                var directStartMonth = $(".directStartMonth").val();
                var directStartDay = $(".directStartDay").val();
                /**/
