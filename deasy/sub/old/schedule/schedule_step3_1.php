...
<div class="budget_wra budget_white_wra">
                ...
                <dl>
                    ...
                    <dd class="thousand">
                        ...
                        <p class="price_arrow up">
                            <img class="hover_off" src="/assets/images/project/P6/up_off_type2.png" alt="">
                            <img class="hover_on" src="/assets/images/project/P6/up_on_type2.png" alt="">
                        </p>
                        <p class="price_arrow down">
                            <img class="hover_off" src="/assets/images/project/P6/down_off_type2.png" alt="">
                            <img class="hover_on" src="/assets/images/project/P6/down_on_type2.png" alt="">
                        </p>
                    </dd>
                </dl>
                <dl>
    ...
    <div class="step_project">
        ...
        <a href="schedule_step2.php" class="arrow_step before">
    ...
    <div class="step_project_m">
        <a href="/sub/old/scheduledule/schedule_step2.php" class="prev">
