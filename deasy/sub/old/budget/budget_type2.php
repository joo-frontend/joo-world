...
<div class="budget_wra">
    ...
    <div class="step_project">
        ...
        <a href="#" class="arrow_step before">
            <img class="before_next focus" src="/assets/images/project/P6/before_off.png" alt="">
            <img class="before_next" src="/assets/images/project/P6/prev_btn.png" alt="">
        </a>
    </div>
    <div class="step_project_m">
        ...
        <a href="/sub/old/budgetdget/budget_step1.php" class="next">
