...
<body>
<div class="wra">
    <div class="header_wra header_blue_wra header_blue_flex_wra">
        <div class="header_area">
            ...
            <a href="/index.php" class="logo_box"><img src="/assets/images/header/header_logo_w.png" alt=""></a>
            ...
            <div class="icon_gnb">
                <ul class="clearfix">
                    ...
                    <li class="search_header_btn"><a href="#">
                            <img class="hover_off" src="/assets/images/project/P1/header_search_white.png" alt="">
                            <img class="hover_on" src="/assets/images/project/P1/header_search_white.png" alt="">
                        </a></li>
                    <!--login전-->
                   ...
                   <!-- <li class="mypage_menu"><a href="/sub/mypage/history_bidding.php">
                            ...
                            <img class="hover_on" src="/assets/images/project/P1/header_mypage.png" alt="">
                        </a></li>
    ...
    <div class="container">
        <script>
            function myFunction(x) {
                if (x.matches) {
                    $(".search_header_btn img").attr("src",'/assets/images/project/P1/header_search.png');
                    $(".alarm_menu img").attr("src",'/assets/images/project/P1/header_notice.png');
                    $(".mypage_menu img").attr("src",'/assets/images/project/P1/header_mypage.png');
                } else {
