...
<body>
<div class="wra">
    <div class="header_wra header_flex_wrap">
    ...
    <div class="container">
        <script>
            function myFunction(x) {
                if (x.matches) {
                    $(".search_header_btn img").attr("src",'/assets/images/project/P1/header_search_white.png');
                    $(".alarm_menu img").attr("src",'/assets/images/project/P1/header_notice_white.png');
                    $(".logo_box img").attr("src",'/assets/images/header/header_logo_w.png');
                } else {
                }
            }
