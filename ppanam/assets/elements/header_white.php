...
<body>
<div class="wra">
    <div class="header_wra header_white_wra">
        <div class="header_area">
            ...
            <a href="/index.php" class="logo">
                <img class="img_white" src="/assets/images/main/logo_white.png" alt="">
                <img class="img_color" src="/assets/images/main/logo_color.png" alt="">
            </a>
            <div class="gnb">
                <ul>
                    ...
                    <li class="focus"><a href="/sub/contact.php">CONTACT</a></li>
                </ul>
            </div>
            </div>
            <div class="right_menuBox">
                <!--<a href="#" class="search">
                    <img class="img_white" src="/assets/images/main/search.png" alt="">
                    <img class="img_black" src="/assets/images/main/search_black.png" alt="">
                </a>-->
                <div class="lang_box">
                    <a href="#" class="kor focus">
                        <img class="focus_off" src="/assets/images/main/korean_off.png" alt="">
