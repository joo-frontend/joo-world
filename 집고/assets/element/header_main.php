...
<div class="wra">
    <div class="header_wra">
        <div class="header_area">
            ...
            <!--<ul class="gnb_left">
                <li><a href="#">시공사례</a></li>
                <li class="focus"><a href="#">시공업체</a></li>
            </ul>-->
            <div class="right_menu_header">
                <a href="#" class="sh_menu"><img src="/assets/images/common/search.png" alt=""></a>
    ...
    <div class="container">
        ...
        <div class="pop_full pop_profile_company">
            <div class="pop_profile_box">
                ...
                <div class="profile_preview">
                    <div class="name_box">
                        <span class="pf_img"><img src="/assets/images/temp/temp_a1.jpg" alt=""></span>
        ...
        <script>
            $(".side_open_menu").click(function () {
                ...
                $(".pop_login_info .close_pop").click(function () {
                    $(".pop_login_info").hide();
