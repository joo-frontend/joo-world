...
<div class="join_wra">
    ...
    <div class="join_area">
        <form name="frmJoinC">
            ...
            <div class="item_join">
                <p class="lb">비밀번호 <span class="chk_frm_msg red">8~16자의 영문 + 숫자 조합으로 입력</span></p>
                <div class="frm_txt">
            ...
            <div class="item_join">
                <p class="lb">비밀번호 확인 <span class="chk_frm_msg">비밀번호가 일치합니다</span></p>
                <div class="frm_txt">
                    <input type="text" class="textbox_gray box_lgth1">
            ...
            <div class="item_join">
                <p class="lb">이메일 <span class="chk_frm_msg">사용하실 수 있습니다</span></p>
            ...
            <div class="item_join">
                ...
                <div class="num_info_join">
                    <p class="lb">휴대폰 번호 <span class="chk_frm_msg">
                ...
                <div class="num_info_join">
                    <p class="lb">인증번호 입력 <span class="chk_frm_msg">인증이 완료되었습니다</span></p>
                    <div class="frm_txt">
            ...
            <div class="item_join">
                <div class="detail_join_option">
                    ...
                    <div class="frm_txt">
                        <select class="selectbox_gray" name="localSelect1">
                        </select> &nbsp;
                        <select class="selectbox_gray" name="localSelect2">
                        </select>
                        <div class="local_possible">
