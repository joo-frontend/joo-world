...
$back_ck = explode("asset",$data["background"]);
if(count($back_ck)>1){
    $ck = 1;
}else {
    $ck =0;
...
<div class="feed_wra">
    ...
    <form action="./do/fix_feed.php" method="POST" enctype="multipart/form-data" id="upload_form">
    <input type="hidden" name="target" value="<?=$target?>">
    <div class="write_feed_area">
        <div class="write_box">
            <textarea name="txtFeed" id="feedTxt" class="txtarea"><?=$data["contents"]?></textarea>
            <p><span><?=mb_strlen($data["contents"],'UTF-8')?></span> / 500</p>
        ...
        <div class="write_preview_box">
            ...
            <div class="my_feed_contents" id="container">
                <p class="bg_card"><img id="feedBg" <?php if($ck==1){ echo 'src="'.$data["background"].'"'; }?> alt="" style="opacity:<?=$data["opacity"]?>; <?php if($ck==0){ echo $data["background"]; }?>;"></p>
                <p class="txt_feed" style="font-family:<?=$data["fontfamily"]?>; font-size:<?=$data["fontsize"]?>px; text-align:<?=$data["align"]?>; color:<?=$data["color"]?>"><?=$data["contents"]?></p>
            </div>
        </div>
    </div>
      <img src="" id="captured">
        ...
        <div class="style_section">
            <div class="style_detail_box font_family_box active">
                ...
                <div class="item_font_family f_notoSans">
                    <input type="radio" id="family1" class="chk_blue" value="'Noto Serif KR', sans-serif" <?php if($data["fontfamily"]=="'Noto Serif KR', sans-serif"){ echo "checked";}?> name="fontfamily">
                ...
                <div class="item_font_family f_notoSerif">
                    <input type="radio" id="family2" class="chk_blue" value="NotoSerifKR, serif" <?php if($data["fontfamily"]=="NotoSerifKR, serif"){ echo "checked";}?>name="fontfamily">
                ...
                <div class="item_font_family f_nanumPen">
                    <input type="radio" id="family3" class="chk_blue" value="'Nanum Pen Script', cursive" <?php if($data["fontfamily"]=="'Nanum Pen Script', cursive"){ echo "checked";}?>name="fontfamily">
                    <label for="family3" class="chk_shape"></label>
                    <label for="family3" class="chk_txt">나눔펜체</label>
                </div>
                <div class="item_font_family f_jua">
                    <input type="radio" id="family4" class="chk_blue" value="Jua, sans-serif" <?php if($data["fontfamily"]=="Jua, sans-serif"){ echo "checked";}?> name="fontfamily">
            ...
            <div class="style_detail_box">
                ...
                <input type="hidden" name="fontsize" id="fontsize" value="<?=$data['fontsize']?>">
            ...
            <div class="style_detail_box align_box ">
                ...
                <div class="align_type left <?php if($data['align']=='left'){ echo "focus";}?>">
                    <span>좌측</span>
                ...
                <div class="align_type center <?php if($data['align']=='center'){ echo "focus";}?>">
                    <span>중앙</span>
                ...
                <div class="align_type right <?php if($data['align']=='right'){ echo "focus";}?>">
                    <span>우측</span>
                ...
                <input type="hidden" name="align" id="align" value="<?=$data['align']?>">
            </div>
            ...
            <div class="style_detail_box">
                ...
                <input type="hidden" name="opacity" id="opacity" value="<?=$data["opacity"]?>">
                <div class="slider_txt">
                    <span>10</span>
                    <span>100</span>
                </div>
            ...
            <div class="style_detail_box none_person_box">
                ...
                <p class="box_icon_alarm <?php if($data["is_anonymous"]==1){ echo "active";}?>">
                    <span></span>
                </p>
                <span class="alarm_status">OFF</span>
                <input type="hidden" name="is_anonymous" id="is_anonymous" value="<?=$data["is_anonymous"]?>">
